...
export interface ApiCustomUserCustomUser extends Struct.SingleTypeSchema {
  collectionName: 'custom_user';
  info: {
    description: 'Custom auth and driver endpoints';
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Trip customers tracked by mobile number';
...
export interface ApiDriverDriver extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    incentives: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    salary_slips: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiExpenseExpense extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'All expenses including fuel receipts';
    displayName: 'Expense';
    pluralName: 'expenses';
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['fuel', 'toll', 'repair', 'food', 'other']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    uploaded_by: Schema.Attribute.Relation<'manyToOne', 'api::driver.driver'>;
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['draft', 'sent', 'paid']> &
      Schema.Attribute.Required &
...
export interface ApiSalarySlipSalarySlip extends Struct.CollectionTypeSchema {
  collectionName: 'salary_slips';
  info: {
    description: 'Monthly salary slips for drivers';
    displayName: 'Salary Slip';
    pluralName: 'salary-slips';
    singularName: 'salary-slip';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    driver: Schema.Attribute.Relation<'manyToOne', 'api::driver.driver'>;
    incentive: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::salary-slip.salary-slip'
    ...
    month: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    net_salary: Schema.Attribute.Decimal & Schema.Attribute.Required;
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTripTrip extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    actual_kms: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    advance_payment: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    ...
    km: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::trip.trip'> &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Text;
    odometer_end: Schema.Attribute.Decimal;
    odometer_start: Schema.Attribute.Decimal;
    origin: Schema.Attribute.String & Schema.Attribute.Required;
    payment_method: Schema.Attribute.Enumeration<['upi', 'cash']>;
    payment_received: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    payment_status: Schema.Attribute.Enumeration<['pending', 'paid']> &
    ...
    trip_source: Schema.Attribute.Enumeration<
      ['ola', 'uber', 'rapido', 'private', 'other']
    > &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::salary-slip.salary-slip': ApiSalarySlipSalarySlip;
